...
and returns; otherwise it reads the number of training and test samples from the parameters file, which can thus be changed without recompiling the program. The two datasets are then generated calling the following function:
\begin{lstlisting}[frame=single, showstringspaces=false]
