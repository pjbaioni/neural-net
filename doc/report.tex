...
\begin{figure}[H]
	...
	\caption{verbose run}
\end{figure}
\noindent commenti: runtime command line options, non rewriting same datasets (separate use of main and write\_set). Poi refinements, automatic alpha decay, niter infatti è minore di 75k. Passare quindi a spiegare come tunare.\\
\section*{Old section}
