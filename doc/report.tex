...
%minimal_output e string--> problema di getpot, almeno su questa architettura. prova anche su ubuntu e moduli nuovi.
%c++14 during development perché auto trailing return spesso. Poi rimosso, credo ovunque, per chiarezza/leggibilità. Mantenuto c++14 perché è stato sviluppato così, ma funziona anche con c++11 (prova).
%muparser per la funzione (lambda) in write_set.cpp? 
